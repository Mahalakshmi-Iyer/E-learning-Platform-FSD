                  ...
                  <div className="carousel-inner">
                    <div className="carousel-item active">
                      <div className="d-flex flex-column align-items-center">
                        ...
                        <Button variant="light" as={Link} to="/signup" disabled={isLoggedIn}>
                          Register Now
                        </Button>
                      </div>
                    </div>
                    ...
                    <div className="carousel-item">
                      <div className="d-flex flex-column align-items-center">
                        ...
                        <Button variant="light" as={Link} to="/courses" disabled={!isLoggedIn}>
                          View Courses
                        </Button>
                      </div>
                    </div>
                    ...
                    <div className="carousel-item">
                      <div className="d-flex flex-column align-items-center">
                        ...
                        <Button variant="light" as={Link} to="/articles" disabled={!isLoggedIn}>
                          Start Learning
                        </Button>
                      </div>
                    </div>
